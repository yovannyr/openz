...
Create a registry
 */
  public static TabTranslationInstanceSpecificData[] set(String adTabId, String adTabTrlInstanceId, String adClientId, String adLanguage, String name, String updatedby, String updatedbyr, String createdby, String createdbyr, String adOrgId, String isactive)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Tab_ID = (?) , AD_Tab_Trl_Instance_ID = (?) , AD_Language = (?) , Name = (?) , AD_Client_ID = (?) , Isactive = (?) , AD_Org_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE ad_tab_trl_instance.AD_Tab_Trl_Instance_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Tab_ID, AD_Tab_Trl_Instance_ID, AD_Language, Name, AD_Client_ID, Isactive, AD_Org_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";

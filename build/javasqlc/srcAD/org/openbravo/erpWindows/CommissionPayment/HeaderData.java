...
Create a registry
 */
  public static HeaderData[] set(String documentno, String updatedby, String updatedbyr, String description, String cInvoiceId, String cInvoiceIdr, String processed, String adClientId, String cCommissionId, String createdby, String createdbyr, String processing, String startdate, String isactive, String cCommissionrunId, String grandtotal, String adOrgId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , C_Commission_ID = (?) , DocumentNo = (?) , Description = (?) , StartDate = TO_DATE(?) , GrandTotal = TO_NUMBER(?) , Processing = (?) , C_Invoice_ID = (?) , IsActive = (?) , Processed = (?) , C_CommissionRun_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, C_Commission_ID, DocumentNo, Description, StartDate, GrandTotal, Processing, C_Invoice_ID, IsActive, Processed, C_CommissionRun_ID, created, createdby, updated, updatedBy)" +

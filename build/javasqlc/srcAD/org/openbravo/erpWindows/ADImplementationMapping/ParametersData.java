...
Create a registry
 */
  public static ParametersData[] set(String adModelObjectId, String line, String name, String createdby, String updatedby, String adModelObjectParaId, String value, String adClientId, String isactive, String adOrgId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Model_Object_Para_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , AD_Model_Object_ID = (?) , Isactive = (?) , Name = (?) , Value = (?) , Line = TO_NUMBER(?) , updated = now(), updatedby = ? " +
      "        WHERE AD_Model_Object_Para.AD_Model_Object_Para_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Model_Object_Para_ID, AD_Client_ID, AD_Org_ID, AD_Model_Object_ID, Isactive, Name, Value, Line, created, createdby, updated, updatedBy)" +

...
Create a registry
 */
  public static OpenClosePeriodControlData[] set(String createdby, String cCalendarId, String adOrgId, String adClientId, String periodaction, String updatedby, String cYearId, String description, String periodno, String isactive, String cPeriodcontrolLogId, String processed, String docbasetype, String processing, String isrecursive)    throws ServletException {
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Client_ID = (?) , C_Periodcontrol_Log_ID = (?) , AD_Org_ID = (?) , C_Calendar_ID = (?) , Isactive = (?) , C_Year_ID = (?) , Periodno = (?) , Periodaction = (?) , Description = (?) , Processed = (?) , Processing = (?) , IsRecursive = (?) , Docbasetype = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, C_Periodcontrol_Log_ID, AD_Org_ID, C_Calendar_ID, Isactive, C_Year_ID, Periodno, Periodaction, Description, Processed, Processing, IsRecursive, Docbasetype, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";

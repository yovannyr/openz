...
Create a registry
 */
  public static EmployeeData[] set(String poPricelistId, String value, String adOrgId, String isemployee, String name, String cBpartnerId, String createdby, String createdbyr, String poPaymenttermId, String adClientId, String isactive, String name2, String updatedby, String updatedbyr)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_BPartner" +
      "        SET C_BPartner_ID = (?) , IsActive = (?) , Value = (?) , IsEmployee = (?) , Name = (?) , Name2 = (?) , PO_PriceList_ID = (?) , PO_PaymentTerm_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_BPartner_ID, IsActive, Value, IsEmployee, Name, Name2, PO_PriceList_ID, PO_PaymentTerm_ID, AD_Client_ID, AD_Org_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";

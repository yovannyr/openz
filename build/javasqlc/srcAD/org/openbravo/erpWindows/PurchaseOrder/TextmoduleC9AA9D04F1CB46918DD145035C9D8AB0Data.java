 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_Order_ID = (?) , Zssi_Order_Textmodule_ID = (?) , Zssi_Textmodule_ID = (?) , AD_Client_ID = (?) , Line = TO_NUMBER(?) , AD_Org_ID = (?) , Islower = (?) , Ismodified = (?) , Text = (?) , Isactive = (?) , updated = now(), updatedby = ? " +
      "        WHERE zssi_order_textmodule.Zssi_Order_Textmodule_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_Order_ID, Zssi_Order_Textmodule_ID, Zssi_Textmodule_ID, AD_Client_ID, Line, AD_Org_ID, Islower, Ismodified, Text, Isactive, created, createdby, updated, updatedBy)" +

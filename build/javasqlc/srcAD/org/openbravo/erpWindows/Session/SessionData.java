...
Create a registry
 */
  public static SessionData[] set(String adOrgId, String serverUrl, String createdby, String createdbyr, String created, String remoteAddr, String websession, String isactive, String remoteHost, String adSessionId, String adClientId, String processed, String updatedby, String updatedbyr, String sessionActive)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE AD_Session" +
      "        SET AD_Client_ID = (?) , Processed = (?) , WebSession = (?) , AD_Org_ID = (?) , IsActive = (?) , AD_Session_ID = (?) , Remote_Addr = (?) , Remote_Host = (?) , Server_Url = (?) , Session_Active = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, Processed, WebSession, AD_Org_ID, IsActive, AD_Session_ID, Remote_Addr, Remote_Host, Server_Url, Session_Active, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";

...
Create a registry
 */
  public static SalesRepVendor8BAE92BA22C14B1487EB2B247FA4A977Data[] set(String cBpartnerId, String poFixmonthday3, String poPricelistId, String value, String adOrgId, String paymentrulepo, String name, String isactive, String isvendor, String createdby, String createdbyr, String poPaymenttermId, String adClientId, String iscreditcard, String updatedby, String updatedbyr, String poFixmonthday, String poFixmonthday2)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_BPartner" +
      "        SET Value = (?) , Name = (?) , IsActive = (?) , IsVendor = (?) , PaymentRulePO = (?) , PO_PaymentTerm_ID = (?) , PO_PriceList_ID = (?) , PO_Fixmonthday3 = TO_NUMBER(?) , C_BPartner_ID = (?) , PO_Fixmonthday2 = TO_NUMBER(?) , PO_Fixmonthday = TO_NUMBER(?) , AD_Client_ID = (?) , AD_Org_ID = (?) , IsCreditcard = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_BPartner.C_BPartner_ID = ? " +
      "                 AND C_BPartner.C_BPartner_ID = ? " +
      "        AND C_BPartner.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Value, Name, IsActive, IsVendor, PaymentRulePO, PO_PaymentTerm_ID, PO_PriceList_ID, PO_Fixmonthday3, C_BPartner_ID, PO_Fixmonthday2, PO_Fixmonthday, AD_Client_ID, AD_Org_ID, IsCreditcard, created, createdby, updated, updatedBy)" +

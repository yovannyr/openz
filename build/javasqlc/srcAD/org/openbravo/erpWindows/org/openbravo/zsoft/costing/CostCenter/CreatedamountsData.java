 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET A_Asset_ID = (?) , AD_Org_ID = (?) , Documentno = (?) , M_Product_ID = (?) , Description = (?) , Dateordered = TO_DATE(?) , Amt = TO_NUMBER(?) , C_Invoiceline_ID = (?) , Zsfi_Macctline_ID = (?) , AD_Client_ID = (?) , Isactive = (?) , A_Asset_Costcenter_V_ID = (?) , Value = (?) , updated = now(), updatedby = ? " +
      "        WHERE A_ASSET_COSTCENTER_V.A_Asset_Costcenter_V_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (A_Asset_ID, AD_Org_ID, Documentno, M_Product_ID, Description, Dateordered, Amt, C_Invoiceline_ID, Zsfi_Macctline_ID, AD_Client_ID, Isactive, A_Asset_Costcenter_V_ID, Value, created, createdby, updated, updatedBy)" +

...
Create a registry
 */
  public static PriceListData[] set(String issopricelist, String createdby, String createdbyr, String enforcepricelimit, String description, String mPricelistId, String cCurrencyId, String name, String isactive, String isdefault, String adOrgId, String updatedby, String updatedbyr, String basepricelistId, String istaxincluded, String adClientId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_PriceList" +
      "        SET BasePriceList_ID = (?) , M_PriceList_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , Name = (?) , Description = (?) , IsActive = (?) , IsDefault = (?) , C_Currency_ID = (?) , IsSOPriceList = (?) , IsTaxIncluded = (?) , EnforcePriceLimit = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (BasePriceList_ID, M_PriceList_ID, AD_Client_ID, AD_Org_ID, Name, Description, IsActive, IsDefault, C_Currency_ID, IsSOPriceList, IsTaxIncluded, EnforcePriceLimit, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";

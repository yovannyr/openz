...
Create a registry
 */
  public static LanguageData[] set(String adLanguage, String name, String adLanguageId, String adOrgId, String updatedby, String updatedbyr, String isbaselanguage, String issystemlanguage, String processing, String countrycode, String isactive, String createdby, String createdbyr, String languageiso, String adClientId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE AD_Language" +
      "        SET AD_Language_ID = (?) , IsActive = (?) , IsSystemLanguage = (?) , Processing = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , AD_Language = (?) , Name = (?) , LanguageISO = (?) , CountryCode = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Language_ID, IsActive, IsSystemLanguage, Processing, AD_Client_ID, AD_Org_ID, AD_Language, Name, LanguageISO, CountryCode, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";

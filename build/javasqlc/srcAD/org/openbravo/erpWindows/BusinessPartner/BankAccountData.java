 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET RoutingNo = (?) , A_Country = (?) , C_BPartner_ID = (?) , AD_User_ID = (?) , IsActive = (?) , AccountNo = (?) , ShowAccountNo = (?) , A_Zip = (?) , Iban = (?) , Showiban = (?) , SwiftCode = (?) , C_Country_ID = (?) , Displayedaccount = (?) , Bank_Name = (?) , A_Name = (?) , MndtIdent = (?) , Dtofsgntr = TO_DATE(?) , A_EMail = (?) , A_Ident_DL = (?) , A_Ident_SSN = (?) , A_City = (?) , A_State = (?) , A_Street = (?) , BankAccountType = (?) , CreditCardExpMM = TO_NUMBER(?) , CreditCardExpYY = TO_NUMBER(?) , CreditCardNumber = (?) , CreditCardType = (?) , R_AvsZip = (?) , C_BP_BankAccount_ID = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_BP_BankAccount.C_BP_BankAccount_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (RoutingNo, A_Country, C_BPartner_ID, AD_User_ID, IsActive, AccountNo, ShowAccountNo, A_Zip, Iban, Showiban, SwiftCode, C_Country_ID, Displayedaccount, Bank_Name, A_Name, MndtIdent, Dtofsgntr, A_City, A_EMail, A_Ident_DL, A_Ident_SSN, A_State, C_BP_BankAccount_ID, AD_Client_ID, CreditCardExpMM, CreditCardExpYY, CreditCardNumber, CreditCardType, R_AvsZip, A_Street, BankAccountType, AD_Org_ID, created, createdby, updated, updatedBy)" +

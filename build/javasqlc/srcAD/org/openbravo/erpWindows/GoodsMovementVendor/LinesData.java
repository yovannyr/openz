...
Create a registry
 */
  public static LinesData[] set(String mInoutId, String line, String movementqty, String mLocatorId, String mLocatorIdr, String mInoutlineId, String mInoutIdr, String mProductUomId, String cUomId, String updatedby, String updatedbyr, String cOrderlineId, String cOrderlineIdr, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String cProjecttaskId, String mProductId, String mProductIdr, String isinvoiced, String cProjectId, String cProjectIdr, String isdescription, String quantityorder, String isactive, String adOrgId, String createdby, String createdbyr, String aAssetId, String adClientId, String description)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_InOutLine" +
      "        SET IsDescription = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , M_InOut_ID = (?) , C_OrderLine_ID = (?) , Description = (?) , Line = TO_NUMBER(?) , M_Locator_ID = (?) , M_Product_ID = (?) , M_AttributeSetInstance_ID = (?) , QuantityOrder = TO_NUMBER(?) , M_Product_Uom_Id = (?) , MovementQty = TO_NUMBER(?) , C_UOM_ID = (?) , A_Asset_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , IsActive = (?) , M_InOutLine_ID = (?) , IsInvoiced = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_InOutLine.M_InOutLine_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (IsDescription, AD_Client_ID, AD_Org_ID, M_InOut_ID, C_OrderLine_ID, Description, Line, M_Locator_ID, M_Product_ID, M_AttributeSetInstance_ID, QuantityOrder, M_Product_Uom_Id, MovementQty, C_UOM_ID, A_Asset_ID, C_Project_ID, C_Projecttask_ID, IsActive, M_InOutLine_ID, IsInvoiced, created, createdby, updated, updatedBy)" +

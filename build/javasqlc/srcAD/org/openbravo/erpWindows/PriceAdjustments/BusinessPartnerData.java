 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Offer_ID = (?) , C_BPartner_ID = (?) , IsActive = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , M_Offer_Bpartner_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_Offer_BPartner.M_Offer_Bpartner_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Offer_ID, C_BPartner_ID, IsActive, AD_Org_ID, AD_Client_ID, M_Offer_Bpartner_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";

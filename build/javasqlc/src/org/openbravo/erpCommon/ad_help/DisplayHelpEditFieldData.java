...
class DisplayHelpEditFieldData implements FieldProvider {
static Logger log4j = Logger.getLogger(DisplayHelpEditFieldData.class);
  ...
  public static DisplayHelpEditFieldData[] select(ConnectionProvider connectionProvider, String id)    throws ServletException {
    return select(connectionProvider, id, 0, 0);
  }

  public static DisplayHelpEditFieldData[] select(ConnectionProvider connectionProvider, String id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        DisplayHelpEditFieldData objectDisplayHelpEditFieldData = new DisplayHelpEditFieldData();
        objectDisplayHelpEditFieldData.id = UtilSql.getValue(result, "id");
        objectDisplayHelpEditFieldData.originalname = UtilSql.getValue(result, "originalname");
        objectDisplayHelpEditFieldData.name = UtilSql.getValue(result, "name");
        objectDisplayHelpEditFieldData.help = UtilSql.getValue(result, "help");
        objectDisplayHelpEditFieldData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectDisplayHelpEditFieldData);
    ...
    DisplayHelpEditFieldData objectDisplayHelpEditFieldData[] = new DisplayHelpEditFieldData[vector.size()];
    vector.copyInto(objectDisplayHelpEditFieldData);
    return(objectDisplayHelpEditFieldData);
  }

  public static DisplayHelpEditFieldData[] selectTrl(ConnectionProvider connectionProvider, String adLanguage, String id)    throws ServletException {
    return selectTrl(connectionProvider, adLanguage, id, 0, 0);
  }

  public static DisplayHelpEditFieldData[] selectTrl(ConnectionProvider connectionProvider, String adLanguage, String id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static DisplayHelpEditFieldData[] selectTab(ConnectionProvider connectionProvider, String id)    throws ServletException {
    return selectTab(connectionProvider, id, 0, 0);
  }

  public static DisplayHelpEditFieldData[] selectTab(ConnectionProvider connectionProvider, String id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static DisplayHelpEditFieldData[] selectTabTrl(ConnectionProvider connectionProvider, String adLanguage, String id)    throws ServletException {
    return selectTabTrl(connectionProvider, adLanguage, id, 0, 0);
  }

  public static DisplayHelpEditFieldData[] selectTabTrl(ConnectionProvider connectionProvider, String adLanguage, String id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static DisplayHelpEditFieldData[] selectField(ConnectionProvider connectionProvider, String id)    throws ServletException {
    return selectField(connectionProvider, id, 0, 0);
  }

  public static DisplayHelpEditFieldData[] selectField(ConnectionProvider connectionProvider, String id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static DisplayHelpEditFieldData[] selectElement(ConnectionProvider connectionProvider, String id)    throws ServletException {
    return selectElement(connectionProvider, id, 0, 0);
  }

  public static DisplayHelpEditFieldData[] selectElement(ConnectionProvider connectionProvider, String id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static DisplayHelpEditFieldData[] selectElementTrl(ConnectionProvider connectionProvider, String adLanguage, String id)    throws ServletException {
    return selectElementTrl(connectionProvider, adLanguage, id, 0, 0);
  }

  public static DisplayHelpEditFieldData[] selectElementTrl(ConnectionProvider connectionProvider, String adLanguage, String id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static DisplayHelpEditFieldData[] selectFieldTrl(ConnectionProvider connectionProvider, String adLanguage, String id)    throws ServletException {
    return selectFieldTrl(connectionProvider, adLanguage, id, 0, 0);
  }

  public static DisplayHelpEditFieldData[] selectFieldTrl(ConnectionProvider connectionProvider, String adLanguage, String id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 

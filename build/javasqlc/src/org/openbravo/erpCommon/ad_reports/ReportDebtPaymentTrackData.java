...
static Logger log4j = Logger.getLogger(ReportDebtPaymentTrackData.class);
  ...
  public static ReportDebtPaymentTrackData[] select(ConnectionProvider connectionProvider, String adLanguage, String adUserClient, String adUserOrg, String cBpartnerId, String dateFrom, String dateTo, String moreThan, String lessThan, String docTypes)    throws ServletException {
    return select(connectionProvider, adLanguage, adUserClient, adUserOrg, cBpartnerId, dateFrom, dateTo, moreThan, lessThan, docTypes, 0, 0);
  }

  public static ReportDebtPaymentTrackData[] select(ConnectionProvider connectionProvider, String adLanguage, String adUserClient, String adUserOrg, String cBpartnerId, String dateFrom, String dateTo, String moreThan, String lessThan, String docTypes, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 

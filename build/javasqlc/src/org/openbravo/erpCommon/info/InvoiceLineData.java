...
static Logger log4j = Logger.getLogger(InvoiceLineData.class);
  ...
  public static InvoiceLineData[] select(ConnectionProvider connectionProvider, String rownum, String adUserClient, String adUserOrg, String documentno, String description, String orderReference, String businesPartner, String dateFrom, String dateTo, String grandTotalFrom, String grandTotalTo, String product, String orderBy, String oraLimit, String pgLimit)    throws ServletException {
    return select(connectionProvider, rownum, adUserClient, adUserOrg, documentno, description, orderReference, businesPartner, dateFrom, dateTo, grandTotalFrom, grandTotalTo, product, orderBy, oraLimit, pgLimit, 0, 0);
  }
  ...
  public static InvoiceLineData[] select(ConnectionProvider connectionProvider, String rownum, String adUserClient, String adUserOrg, String documentno, String description, String orderReference, String businesPartner, String dateFrom, String dateTo, String grandTotalFrom, String grandTotalTo, String product, String orderBy, String oraLimit, String pgLimit, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      "      	SELECT B.*," +
      "      		C_INVOICELINE_ID || '#' || (DOCUMENTNO || ' - ' || DATEINVOICED || ' - ' || GRANDTOTAL || ' - ' || LINE || ' - ' || LINENETAMT) AS ROWKEY," +
  ...
  public static InvoiceLineData[] selectKey(ConnectionProvider connectionProvider, String adUserClient, String adUserOrg, String key)    throws ServletException {
    return selectKey(connectionProvider, adUserClient, adUserOrg, key, 0, 0);
  }

  public static InvoiceLineData[] selectKey(ConnectionProvider connectionProvider, String adUserClient, String adUserOrg, String key, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + ((adUserOrg==null || adUserOrg.equals(""))?"":adUserOrg);
    strSql = strSql + 

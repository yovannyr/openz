...
static Logger log4j = Logger.getLogger(ProductMultipleData.class);
  ...
  public static ProductMultipleData[] select(ConnectionProvider connectionProvider, String rownum, String key, String name, String productCategory, String adUserClient, String adUserOrg, String orderBy, String pgLimit, String oraLimit1, String oraLimit2)    throws ServletException {
    return select(connectionProvider, rownum, key, name, productCategory, adUserClient, adUserOrg, orderBy, pgLimit, oraLimit1, oraLimit2, 0, 0);
  }

  public static ProductMultipleData[] select(ConnectionProvider connectionProvider, String rownum, String key, String name, String productCategory, String adUserClient, String adUserOrg, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT * FROM ( SELECT ";
    ...
    strSql = strSql + 
      ...
      "        p.C_UOM_ID, pc.name as PRODUCT_CATEGORY, p.M_Product_ID || '#' || p.Name as RowKey" +
  ...
  public static String countRows(ConnectionProvider connectionProvider, String rownum, String key, String name, String productCategory, String adUserClient, String adUserOrg, String pgLimit, String oraLimit1, String oraLimit2)    throws ServletException {
    String strSql = "";
    strSql = strSql + 

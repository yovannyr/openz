...
static Logger log4j = Logger.getLogger(SLOrderTaxData.class);
  ...
  public static String selectTax(ConnectionProvider connectionProvider, String strCBPartnerLocationID, String strMProductID, String strADOrgID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 

 ...
 */
  ...
  public static String selectCrossPeriodCount(ConnectionProvider connectionProvider, String adClientId, String DateFrom, String DateTo)    throws ServletException {
    String strSql = "";
    strSql = strSql + 

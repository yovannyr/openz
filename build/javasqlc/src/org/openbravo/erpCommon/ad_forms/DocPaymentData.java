...
static Logger log4j = Logger.getLogger(DocPaymentData.class);
  ...
  public static DocPaymentData[] selectBPartnerCustomerAcct(ConnectionProvider connectionProvider, String C_BPARTNER_ID, String C_ACCTSCHEMA_ID)    throws ServletException {
    return selectBPartnerCustomerAcct(connectionProvider, C_BPARTNER_ID, C_ACCTSCHEMA_ID, 0, 0);
  }

  public static DocPaymentData[] selectBPartnerCustomerAcct(ConnectionProvider connectionProvider, String C_BPARTNER_ID, String C_ACCTSCHEMA_ID, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static DocPaymentData[] selectBPartnerVendorAcct(ConnectionProvider connectionProvider, String C_BPARTNER_ID, String C_ACCTSCHEMA_ID)    throws ServletException {
    return selectBPartnerVendorAcct(connectionProvider, C_BPARTNER_ID, C_ACCTSCHEMA_ID, 0, 0);
  }

  public static DocPaymentData[] selectBPartnerVendorAcct(ConnectionProvider connectionProvider, String C_BPARTNER_ID, String C_ACCTSCHEMA_ID, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String selectAccount(ConnectionProvider connectionProvider, String strCBPartnerLocationID, String strMProductID, String strADOrgID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "           SELECT zsfi_GetTax(?, ?, ?) FROM DUAL";
    ...
    try {
    st = connectionProvider.getPreparedStatement(strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, strCBPartnerLocationID);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "zsfi_gettax");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);
  ...
  public static String selectWDAccount(ConnectionProvider connectionProvider, String strAcctType, String strCInvoiceID, String strAcctSchemaID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "           SELECT zsfi_GetWDAccount(?, ?, ?) FROM DUAL";
    ...
    try {
    st = connectionProvider.getPreparedStatement(strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, strAcctType);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, strCInvoiceID);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, strAcctSchemaID);

      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "zsfi_getwdaccount");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);
  ...
  public static String selectTaxAmount(ConnectionProvider connectionProvider, String strCInvoiceID, String strAmount, String strCCurrencyID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "           SELECT zsfi_GetTaxAmtFromAmt(?, ?, ?) FROM DUAL";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, strCInvoiceID);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, strAmount);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, strCCurrencyID);

      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "zsfi_gettaxamtfromamt");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);

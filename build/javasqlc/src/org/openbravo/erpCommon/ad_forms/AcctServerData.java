...
static Logger log4j = Logger.getLogger(AcctServerData.class);
  ...
  public static int insertNote(Connection conn, ConnectionProvider connectionProvider, String note, String client, String org, String user, String text, String reference, String table, String Record, String messageValue)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int updateSave(ConnectionProvider connectionProvider, String tableName, String status, String Record_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        UPDATE ";
    strSql = strSql + ((tableName==null || tableName.equals(""))?"":tableName);
    strSql = strSql + 
      " SET Posted= ? ,Processing='N'" +
      "        WHERE ";
    strSql = strSql + ((tableName==null || tableName.equals(""))?"":tableName);
    strSql = strSql + 
      "_ID = ?";
  ...
  public static int insertFactError(Connection conn, ConnectionProvider connectionProvider, String client, String org, String user, String docno, String dateacct, String doctype, String status, String table, String id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        INSERT INTO zsfi_fact_error_log (ZSFI_FACT_ERROR_LOG_ID, AD_CLIENT_ID, AD_ORG_ID,  CREATED, CREATEDBY, UPDATED, UPDATEDBY, " +
      "                     DOCUMENTNO, DATEACCT, DOCUMENTTYPE, STATUS, TABLENAME,SOURCEID)" +

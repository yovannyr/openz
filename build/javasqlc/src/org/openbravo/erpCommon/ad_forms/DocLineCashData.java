...
static Logger log4j = Logger.getLogger(DocLineCashData.class);
  ...
  public static String selectDescription(ConnectionProvider connectionProvider, String cashLineId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT description from c_cashline where c_cashline_id=?";

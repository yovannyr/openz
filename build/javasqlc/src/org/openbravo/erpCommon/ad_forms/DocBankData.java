  ...
  public static DocBankData[] select(ConnectionProvider connectionProvider, String C_BankAccount_ID, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectDocBankData.foreigncurrency = UtilSql.getValue(result, "foreigncurrency");
        objectDocBankData.foreigncurrencyamt = UtilSql.getValue(result, "foreigncurrencyamt");
        objectDocBankData.foreigncurrencyrate = UtilSql.getValue(result, "foreigncurrencyrate");

...
static Logger log4j = Logger.getLogger(ProcessRequestData.class);
  ...
  public static int insert(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String createdby, String updatedby, String id, String processId, String user, String status, String channel, String obContext, String params, String previousFireTime, String nextFireTime, String scheduledFinish)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int update(ConnectionProvider connectionProvider, String status, String nextFireTime, String scheduledFinish, String id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      	UPDATE AD_Process_Request" +
      "      	SET Updated = NOW(), Status = ?," +
  ...
  public static int update(ConnectionProvider connectionProvider, String status, String channel, String previousFireTime, String nextFireTime, String scheduledFinish, String id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      	UPDATE AD_Process_Request" +
  ...
  public static int update(ConnectionProvider connectionProvider, String updatedBy, String user, String status, String channel, String previousFireTime, String nextFireTime, String scheduledFinish, String obContext, String id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      	UPDATE AD_Process_Request" +

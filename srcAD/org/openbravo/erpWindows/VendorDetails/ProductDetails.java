...
*/
  private ProductDetailsData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_BPartner_ID) throws IOException,ServletException {
   ...
   private ProductDetailsData[] getRelationData(ProductDetailsData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 44);        data[i].upc = FormatUtilities.truncate(data[i].upc, 20);        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 44);        data[i].cUomId = FormatUtilities.truncate(data[i].cUomId, 44);        data[i].vendorproductno = FormatUtilities.truncate(data[i].vendorproductno, 20);        data[i].vendorcategory = FormatUtilities.truncate(data[i].vendorcategory, 20);        data[i].mManufacturerId = FormatUtilities.truncate(data[i].mManufacturerId, 32);        data[i].manufacturernumber = FormatUtilities.truncate(data[i].manufacturernumber, 20);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].mProductPoId = FormatUtilities.truncate(data[i].mProductPoId, 32);}
    }
    return data;
  }

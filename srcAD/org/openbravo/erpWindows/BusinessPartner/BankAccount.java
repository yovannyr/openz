...
*/
  private BankAccountData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_BPartner_ID) throws IOException,ServletException {
   ...
   private BankAccountData[] getRelationData(BankAccountData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].routingno = FormatUtilities.truncate(data[i].routingno, 20);        data[i].aCountry = FormatUtilities.truncate(data[i].aCountry, 20);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);        data[i].adUserId = FormatUtilities.truncate(data[i].adUserId, 44);        data[i].accountno = FormatUtilities.truncate(data[i].accountno, 30);        data[i].aZip = FormatUtilities.truncate(data[i].aZip, 20);        data[i].iban = FormatUtilities.truncate(data[i].iban, 34);        data[i].swiftcode = FormatUtilities.truncate(data[i].swiftcode, 11);        data[i].cCountryId = FormatUtilities.truncate(data[i].cCountryId, 12);        data[i].displayedaccount = FormatUtilities.truncate(data[i].displayedaccount, 26);        data[i].bankName = FormatUtilities.truncate(data[i].bankName, 34);        data[i].aName = FormatUtilities.truncate(data[i].aName, 20);        data[i].mndtident = FormatUtilities.truncate(data[i].mndtident, 35);        data[i].aCity = FormatUtilities.truncate(data[i].aCity, 20);        data[i].aEmail = FormatUtilities.truncate(data[i].aEmail, 20);        data[i].aIdentDl = FormatUtilities.truncate(data[i].aIdentDl, 20);        data[i].aIdentSsn = FormatUtilities.truncate(data[i].aIdentSsn, 20);        data[i].aState = FormatUtilities.truncate(data[i].aState, 20);        data[i].cBpBankaccountId = FormatUtilities.truncate(data[i].cBpBankaccountId, 10);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].creditcardnumber = FormatUtilities.truncate(data[i].creditcardnumber, 20);        data[i].creditcardtype = FormatUtilities.truncate(data[i].creditcardtype, 21);        data[i].rAvszip = FormatUtilities.truncate(data[i].rAvszip, 21);        data[i].aStreet = FormatUtilities.truncate(data[i].aStreet, 20);        data[i].bankaccounttype = FormatUtilities.truncate(data[i].bankaccounttype, 21);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);}
    }
    return data;
  }

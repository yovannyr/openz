...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strC_BPartner_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|Value", data[0].getField("value"));    vars.setSessionValue(windowId + "|C_BPartner_ID", data[0].getField("cBpartnerId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
...
String strParamAD_Org_ID = vars.getSessionValue(tabId + "|paramAD_Org_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = CustomerData.set(strPC_BPartner_ID, Utility.getDefault(this, vars, "IsCustomer", "N", "123", "223", "N", dataField), Utility.getDefault(this, vars, "DocumentCopies", "", "123", "223", "", dataField), CustomerData.selectDef2901(this, Utility.getContext(this, vars, "AD_ORG_ID", "123")), Utility.getDefault(this, vars, "Fixmonthday3", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "Name", "", "123", "223", "", dataField), "Y", Utility.getDefault(this, vars, "InvoiceRule", "I", "123", "223", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "123", "223", "", dataField), CustomerData.selectDef2898_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "123", "223", "", dataField)), Utility.getDefault(this, vars, "FixMonthDay", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "Isecommerceactive", "Y", "123", "223", "N", dataField), Utility.getDefault(this, vars, "IsDiscountPrinted", "", "123", "223", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "123", "223", "", dataField), CustomerData.selectDef2900_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "123", "223", "", dataField)), Utility.getDefault(this, vars, "SO_Description", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "FixMonthDay2", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "123", "223", "", dataField), Utility.getDefault(this, vars, "Invoicegrouping", "000000000000000", "123", "223", "", dataField), Utility.getDefault(this, vars, "SO_CreditUsed", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "SO_Bankaccount_ID", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "DeliveryRule", "A", "123", "223", "", dataField), Utility.getDefault(this, vars, "POReference", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "D", "123", "223", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "C_InvoiceSchedule_ID", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "123", "223", "", dataField), Utility.getDefault(this, vars, "Iscustomerpricelist", "N", "123", "223", "N", dataField), Utility.getDefault(this, vars, "PaymentRule", "R", "123", "223", "", dataField), Utility.getDefault(this, vars, "SO_CreditLimit", "", "123", "223", "", dataField));

...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strZSE_Ecommercegrant_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|ZSE_Ecommercegrant_ID", data[0].getField("zseEcommercegrantId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZSE_Ecommercegrant_ID, String strPC_Bpartner_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ECommerceSettingsData.set(strPC_Bpartner_ID, Utility.getDefault(this, vars, "Paymentmethod", "", "123", "B57B46FF98AC4D9B96D4D0C9328931A8", "", dataField), Utility.getDefault(this, vars, "Bpartneridremote", "", "123", "B57B46FF98AC4D9B96D4D0C9328931A8", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "123", "B57B46FF98AC4D9B96D4D0C9328931A8", "", dataField), "", Utility.getDefault(this, vars, "Updatedby", "", "123", "B57B46FF98AC4D9B96D4D0C9328931A8", "", dataField), ECommerceSettingsData.selectDefF80E51DF3CCB4316A7793D1DDB7C422A_0(this, Utility.getDefault(this, vars, "Updatedby", "", "123", "B57B46FF98AC4D9B96D4D0C9328931A8", "", dataField)), Utility.getDefault(this, vars, "ZSE_Shop_ID", "", "123", "B57B46FF98AC4D9B96D4D0C9328931A8", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "123", "B57B46FF98AC4D9B96D4D0C9328931A8", "", dataField), ECommerceSettingsData.selectDefDD67E48472694C7A8CB6373910541B2D_1(this, Utility.getDefault(this, vars, "Createdby", "", "123", "B57B46FF98AC4D9B96D4D0C9328931A8", "", dataField)), Utility.getDefault(this, vars, "Orgidremote", "", "123", "B57B46FF98AC4D9B96D4D0C9328931A8", "", dataField), ECommerceSettingsData.selectDef8D5029E621AC4B4F9D3FEA6215A57F07_2(this, strPC_Bpartner_ID), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "123", "B57B46FF98AC4D9B96D4D0C9328931A8", "", dataField));

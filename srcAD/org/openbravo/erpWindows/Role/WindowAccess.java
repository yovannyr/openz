  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Window_Access_ID, String strPAD_Role_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = WindowAccessData.set(strPAD_Role_ID, Utility.getDefault(this, vars, "CreatedBy", "", "111", "304", "", dataField), WindowAccessData.selectDef1335_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "111", "304", "", dataField)), "Y", Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "111", "304", "", dataField), Utility.getDefault(this, vars, "AD_Window_ID", "", "111", "304", "", dataField), Utility.getDefault(this, vars, "IsReadWrite", "", "111", "304", "N", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "111", "304", "", dataField), Utility.getDefault(this, vars, "Seesonlyowndata", "N", "111", "304", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "111", "304", "", dataField), WindowAccessData.selectDef1337_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "111", "304", "", dataField)));

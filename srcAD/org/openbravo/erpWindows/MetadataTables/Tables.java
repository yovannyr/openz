...
*/
  private TablesData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    try {
    data.adMetadataTableId = vars.getRequestGlobalVariable("inpadMetadataTableId", windowId + "|AD_Metadata_Table_ID");     data.adMetadataTablename = vars.getStringParameter("inpadMetadataTablename");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");    try {   data.sort4upgrade = vars.getNumericParameter("inpsort4upgrade");  } catch (ServletException paramEx) { ex = paramEx; }     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");    try {   data.sort4import = vars.getNumericParameter("inpsort4import");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.upgradeAd = vars.getNumericParameter("inpupgradeAd");  } catch (ServletException paramEx) { ex = paramEx; }     data.moduleWhereclause = vars.getStringParameter("inpmoduleWhereclause");     data.adModuleId = vars.getStringParameter("inpadModuleId"); 

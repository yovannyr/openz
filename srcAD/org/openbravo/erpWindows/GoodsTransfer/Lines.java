...
String strParamMovementQty_f = vars.getSessionValue(tabId + "|paramMovementQty_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPM_Movement_ID, Utility.getDefault(this, vars, "UpdatedBy", "", "170", "260", "", dataField), LinesData.selectDef3589_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "170", "260", "", dataField)), Utility.getDefault(this, vars, "C_UOM_ID", "", "170", "260", "", dataField), Utility.getDefault(this, vars, "M_Locator_ID", "@M_Locator_ID@", "170", "260", "", dataField), LinesData.selectDef3591_1(this, Utility.getDefault(this, vars, "M_Locator_ID", "@M_Locator_ID@", "170", "260", "", dataField)), "Y", Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "170", "260", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "170", "260", "", dataField), LinesData.selectDef3587_2(this, Utility.getDefault(this, vars, "CreatedBy", "", "170", "260", "", dataField)), Utility.getDefault(this, vars, "M_Product_ID", "", "170", "260", "", dataField), LinesData.selectDef3593_3(this, Utility.getDefault(this, vars, "M_Product_ID", "", "170", "260", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "170", "260", "", dataField), LinesData.selectDef3820(this, strPM_Movement_ID), Utility.getDefault(this, vars, "QuantityOrder", "", "170", "260", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "170", "260", "", dataField), LinesData.selectDef8551_4(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "170", "260", "", dataField)), "", Utility.getDefault(this, vars, "M_LocatorTo_ID", "@M_LocatorTo_ID@", "170", "260", "", dataField), LinesData.selectDef3592_5(this, Utility.getDefault(this, vars, "M_LocatorTo_ID", "@M_LocatorTo_ID@", "170", "260", "", dataField)), Utility.getDefault(this, vars, "Description", "", "170", "260", "", dataField), Utility.getDefault(this, vars, "MovementQty", "1", "170", "260", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "170", "260", "", dataField));

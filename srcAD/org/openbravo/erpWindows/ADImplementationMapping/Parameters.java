...
*/
  private ParametersData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Model_Object_ID) throws IOException,ServletException {
   ...
   private ParametersData[] getRelationData(ParametersData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adModelObjectParaId = FormatUtilities.truncate(data[i].adModelObjectParaId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].adModelObjectId = FormatUtilities.truncate(data[i].adModelObjectId, 32);        data[i].name = FormatUtilities.truncate(data[i].name, 50);        data[i].value = FormatUtilities.truncate(data[i].value, 20);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Model_Object_Para_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Model_Object_Para_ID", data[0].getField("adModelObjectParaId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Model_Object_Para_ID, String strPAD_Model_Object_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ParametersData.set(strPAD_Model_Object_ID, ParametersData.selectDef1E2EDCC0A13111DDB2632F951DE8183B(this, strPAD_Model_Object_ID), Utility.getDefault(this, vars, "Name", "", "08F09D2A7C774585B014C06C0F44F591", "4A00053300254EBC8868ABADEBD95525", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "08F09D2A7C774585B014C06C0F44F591", "4A00053300254EBC8868ABADEBD95525", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "08F09D2A7C774585B014C06C0F44F591", "4A00053300254EBC8868ABADEBD95525", "", dataField), "", Utility.getDefault(this, vars, "Value", "", "08F09D2A7C774585B014C06C0F44F591", "4A00053300254EBC8868ABADEBD95525", "", dataField), "0", "Y", "0");

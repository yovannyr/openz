   ...
   private WorktimeAccount7D13783F51684D14A6C4C77D3AFF7828Data[] getRelationData(WorktimeAccount7D13783F51684D14A6C4C77D3AFF7828Data[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|C_Empworktimeaccount_ID", data[0].getField("cEmpworktimeaccountId"));
    }

   ...
   private Main8FBAA16AD68140C8AF41D76BB9B882F1Data[] getRelationData(Main8FBAA16AD68140C8AF41D76BB9B882F1Data[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|Zssi_Crm_Todos_ID", data[0].getField("zssiCrmTodosId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }

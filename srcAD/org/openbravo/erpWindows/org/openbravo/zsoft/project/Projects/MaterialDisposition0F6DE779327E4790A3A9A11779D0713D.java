...
*/
  private MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Projecttask_ID) throws IOException,ServletException {
   ...
   private MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData[] getRelationData(MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].cProjecttaskId = FormatUtilities.truncate(data[i].cProjecttaskId, 32);        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 32);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].constuctivemeasure = FormatUtilities.truncate(data[i].constuctivemeasure, 50);        data[i].rawmaterial = FormatUtilities.truncate(data[i].rawmaterial, 50);        data[i].mLocatorId = FormatUtilities.truncate(data[i].mLocatorId, 32);        data[i].mRequisitionlineId = FormatUtilities.truncate(data[i].mRequisitionlineId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].zspmProjecttaskbomViewId = FormatUtilities.truncate(data[i].zspmProjecttaskbomViewId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strZspm_Projecttaskbom_View_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|Zspm_Projecttaskbom_View_ID", data[0].getField("zspmProjecttaskbomViewId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZspm_Projecttaskbom_View_ID, String strPC_Projecttask_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.set(strPC_Projecttask_ID, Utility.getDefault(this, vars, "QTY_Instock", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "isreturnafteruse", "N", "130", "0F6DE779327E4790A3A9A11779D0713D", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "plannedamt", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "Date_Nextreceipt", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.selectDef36D3710C11BA4C478269FA855BD6F9F1_0(this, Utility.getDefault(this, vars, "M_Product_ID", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField)), Utility.getDefault(this, vars, "Constuctivemeasure", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "M_Locator_ID", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.selectDefA6B12CC55F2040858356D4D480345AD2_1(this, Utility.getDefault(this, vars, "M_Locator_ID", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.selectDefB58091F4A926457D863F0E2200F63AD1_2(this, Utility.getDefault(this, vars, "Updatedby", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField)), Utility.getDefault(this, vars, "Actualcosamount", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), "Y", MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.selectDefA7975728970945138506C6579D71286E(this, strPC_Projecttask_ID), Utility.getDefault(this, vars, "Cutoff", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "Qtyreceived", "0", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "Date_Plan", "@#Date@", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "QTY_Nextreceipt", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "QTY_Inconsumption", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "Qtyreserved", "0", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "QTY_Ordered", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "Qtyinrequisition", "0", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), "", Utility.getDefault(this, vars, "Quantity", "1", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "Rawmaterial", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "Description", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "QTY_Available", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "QTY_Plan", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "Planrequisition", "N", "130", "0F6DE779327E4790A3A9A11779D0713D", "N", dataField), Utility.getDefault(this, vars, "Createdby", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.selectDef3705F5804CE2418589BE19F9AC2ECB35_3(this, Utility.getDefault(this, vars, "Createdby", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField), Utility.getDefault(this, vars, "M_Requisitionline_ID", "", "130", "0F6DE779327E4790A3A9A11779D0713D", "", dataField));

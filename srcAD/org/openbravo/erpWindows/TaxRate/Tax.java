...
*/
  private TaxData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private TaxData[] getRelationData(TaxData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].sopotype = FormatUtilities.truncate(data[i].sopotype, 21);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].name = FormatUtilities.truncate(data[i].name, 50);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].taxhint = FormatUtilities.truncate(data[i].taxhint, 50);        data[i].cCountryId = FormatUtilities.truncate(data[i].cCountryId, 44);        data[i].datevkeyvst = FormatUtilities.truncate(data[i].datevkeyvst, 2);        data[i].datevkeyust = FormatUtilities.truncate(data[i].datevkeyust, 2);        data[i].cTaxId = FormatUtilities.truncate(data[i].cTaxId, 10);        data[i].cRegionId = FormatUtilities.truncate(data[i].cRegionId, 44);        data[i].toCountryId = FormatUtilities.truncate(data[i].toCountryId, 44);        data[i].toRegionId = FormatUtilities.truncate(data[i].toRegionId, 44);}
    }
    return data;
  }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Tax_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = TaxData.set(Utility.getDefault(this, vars, "C_Country_ID", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "IsDefault", "", "137", "174", "N", dataField), Utility.getDefault(this, vars, "Adduid2fact", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "C_Region_ID", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Originalrate", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Deducpercent", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Taxhint", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "137", "174", "", dataField), TaxData.selectDef2245_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "137", "174", "", dataField)), Utility.getDefault(this, vars, "To_Country_ID", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Datevkeyvst", "", "137", "174", "", dataField), "Y", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "137", "174", "", dataField), Utility.getDefault(this, vars, "To_Region_ID", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Reversecharge", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "IsNoTaxable", "", "137", "174", "N", dataField), Utility.getDefault(this, vars, "Datevkeyust", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Line", "10", "137", "174", "", dataField), Utility.getDefault(this, vars, "Rate", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Cascade", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "IsTaxExempt", "", "137", "174", "N", dataField), Utility.getDefault(this, vars, "ValidFrom", "", "137", "174", "", dataField), "", Utility.getDefault(this, vars, "SOPOType", "B", "137", "174", "", dataField), Utility.getDefault(this, vars, "IsSummary", "", "137", "174", "N", dataField), Utility.getDefault(this, vars, "IsNoVAT", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "IsTaxUndeductable", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "Name", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "IsWithholdingTax", "", "137", "174", "N", dataField), Utility.getDefault(this, vars, "Created", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "137", "174", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "137", "174", "", dataField), TaxData.selectDef2277_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "137", "174", "", dataField)), Utility.getDefault(this, vars, "Description", "", "137", "174", "", dataField));

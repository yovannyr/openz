...
/**
 * Entity class for entity C_Salary_Category_trl (stored in table C_Salary_Category_trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class C_Salary_Category_trl extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "C_Salary_Category_trl";
    public static final String ENTITY_NAME = "C_Salary_Category_trl";

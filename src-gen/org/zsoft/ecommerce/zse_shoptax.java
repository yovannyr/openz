...
/**
 * Entity class for entity zse_shoptax (stored in table zse_shoptax).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zse_shoptax extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zse_shoptax";
    public static final String ENTITY_NAME = "zse_shoptax";

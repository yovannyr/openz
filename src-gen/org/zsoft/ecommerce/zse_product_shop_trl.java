...
/**
 * Entity class for entity zse_product_shop_trl (stored in table zse_product_shop_trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zse_product_shop_trl extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zse_product_shop_trl";
    public static final String ENTITY_NAME = "zse_product_shop_trl";

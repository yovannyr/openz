...
/**
 * Entity class for entity zse_shopimportlog (stored in table zse_shopimportlog).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zse_shopimportlog extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zse_shopimportlog";
    public static final String ENTITY_NAME = "zse_shopimportlog";
    ...
    public static final String PROPERTY_EXECUTIONSTATUS = "executionstatus";

    public zse_shopimportlog() {
    ...
    public String getExecutionstatus() {
        return (String) get(PROPERTY_EXECUTIONSTATUS);
    }

    public void setExecutionstatus(String executionstatus) {
        set(PROPERTY_EXECUTIONSTATUS, executionstatus);
    }
}

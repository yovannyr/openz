...
/**
 * Entity class for entity ca_lostassets_v (stored in table ca_lostassets_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ca_lostassets_v extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ca_lostassets_v";
    public static final String ENTITY_NAME = "ca_lostassets_v";

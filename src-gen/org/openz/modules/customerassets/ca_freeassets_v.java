...
/**
 * Entity class for entity ca_freeassets_v (stored in table ca_freeassets_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ca_freeassets_v extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ca_freeassets_v";
    public static final String ENTITY_NAME = "ca_freeassets_v";

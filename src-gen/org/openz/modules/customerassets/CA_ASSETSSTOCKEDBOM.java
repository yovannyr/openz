...
/**
 * Entity class for entity CA_ASSETSSTOCKEDBOM (stored in table CA_ASSETSSTOCKEDBOM).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class CA_ASSETSSTOCKEDBOM extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "CA_ASSETSSTOCKEDBOM";
    public static final String ENTITY_NAME = "CA_ASSETSSTOCKEDBOM";
    ...
    public CA_ASSETSSTOCKEDBOM() {
        ...
        setDefaultValue(PROPERTY_BOMQTY, new BigDecimal(0));
    }

...
/**
 * Entity class for entity ad_process_onlineapistatus_v (stored in table ad_process_onlineapistatus_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ad_process_onlineapistatus_v extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ad_process_onlineapistatus_v";
    public static final String ENTITY_NAME = "ad_process_onlineapistatus_v";
    ...
    public ad_process_onlineapistatus_v() {

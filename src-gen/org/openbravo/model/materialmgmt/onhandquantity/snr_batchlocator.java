...
/**
 * Entity class for entity snr_batchlocator (stored in table snr_batchlocator).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class snr_batchlocator extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "snr_batchlocator";
    public static final String ENTITY_NAME = "snr_batchlocator";

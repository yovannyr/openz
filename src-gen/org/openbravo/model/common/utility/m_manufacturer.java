...
/**
 * Entity class for entity m_manufacturer (stored in table m_manufacturer).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class m_manufacturer extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "m_manufacturer";
    public static final String ENTITY_NAME = "m_manufacturer";

...
*/
  ...
  //  alert (this.div.clientWidth);
   ...
   // alert (scrollwidh  + viewwidth);
    ...
    if (is_chrome){
    if  (scrollwidh > viewwidth+2) { 
      //  alert(rowadd);
      if (rowadd==31){rowadd=29;}
      if (rowadd==30){rowadd=31;}
      if (rowadd==39){rowadd=31;}
      if (rowadd==44){rowadd=31;}
     
        this.div.style.height = (this.rowHeight * visibleRows) + this.div.firstChild.offsetHeight + rowadd + "px";
	
    }
    else {
      
        this.div.style.height = (this.rowHeight * visibleRows) + this.div.firstChild.offsetHeight + 13.99 + "px";
         
    }}else{
 
      this.div.style.height = (this.rowHeight * visibleRows) + this.div.firstChild.offsetHeight + 14 + "px";}
...
*/
  ...
  var rowadd = visibleRows+6;
    ...
    if  (scrollwidh > viewwidth+2) {
      ...
      if (rowadd==30){rowadd=31;}
      if (rowadd==39){rowadd=31;}
        this.div.style.height = (this.rowHeight * this.liveGrid.visibleRows) + this.div.firstChild.offsetHeight + rowadd + "px";
       
    }
    else {
       
        this.div.style.height = (this.rowHeight * this.liveGrid.visibleRows) + this.div.firstChild.offsetHeight + 13.99 + "px";
        
    }}
    else{this.div.style.height = (this.rowHeight * this.liveGrid.visibleRows) + this.div.firstChild.offsetHeight + 14 + "px";}

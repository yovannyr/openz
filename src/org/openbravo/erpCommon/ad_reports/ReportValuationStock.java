...
public class ReportValuationStock extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT", "RELATION")) {
      ...
      printPageDataPdf(request, response, vars, strDate, strWarehouse, strCategoryProduct,
          strCurrencyId);
    }
    else
      pageError(response);
  ...
  private void printPageDataPdf(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars,       
      String strDate, String strWarehouse, String strCategoryProduct,
      String strCurrencyId) throws IOException, ServletException {
    String strAux = "";
    String discard[] = { "discard" };
    ...
    String strAD_Org_ID= vars.getUserOrg();
    String strBaseCurrencyId = Utility.stringBaseCurrencyId(this, vars.getClient());
    OBError myMessage = null;
    myMessage = new OBError();
    String strConvRateErrorMsg = "";
  ...
  if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
    ...
    strReportName = this.strBasePath + "/src-loc/design/org/openbravo/erpCommon/ad_reports/Rpt_ValuationStock.jrxml";;

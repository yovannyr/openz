...
public class ReportProjectProfitabilityJR extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String strofferFrom=vars.getStringParameter("inpofferdatefrom");
    String strofferTo=vars.getStringParameter("inpofferdateto");
    String strorderFrom=vars.getStringParameter("inporderdatefrom");
    String strorderTo=vars.getStringParameter("inporderdateto");
    String strstartFrom=vars.getStringParameter("inpdatepromisedfrom");
    String strstartTo=vars.getStringParameter("inpdatepromisedto");
    String strinvoiceFrom=vars.getStringParameter("inpdateinvoicedfrom");
    String strinvoiceTo=vars.getStringParameter  ("inpdateinvoicedto");

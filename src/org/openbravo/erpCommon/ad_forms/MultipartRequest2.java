...
public class MultipartRequest2 implements FieldProvider {
  ...
  public MultipartRequest2() {
  }

  public MultipartRequest2(VariablesBase vars, String filename, boolean firstLineHeads,
      String format, FieldProvider[] data) throws IOException {
    init(vars, filename, firstLineHeads, format, data);
    readSubmittedFile();
  }

  public MultipartRequest2(VariablesBase vars, InputStream in, boolean firstLineHeads,
      String format, FieldProvider[] data) throws IOException {
  ...
  public MultipartRequest2(VariablesBase vars, String filename, boolean firstLineHeads,
      String format, FieldProvider[] data, String countrows) throws IOException {
    init(vars, filename, firstLineHeads, format, data, countrows);
    readSubmittedFile();
  }

  public MultipartRequest2(VariablesBase vars, InputStream in, boolean firstLineHeads,
      String format, FieldProvider[] data, String countrows) throws IOException {
    init(vars, "", firstLineHeads, format, data, countrows);
    readSubmittedFile(in);
  }
  ...
  public void init(VariablesBase vars, String filename, boolean firstLineHeads, String format,
      FieldProvider[] data, String countrows) throws IOException {
    if (vars == null)
      throw new IllegalArgumentException("VariablesBase cannot be null");
    // if (filename==null || filename.equals("")) throw new
    // IllegalArgumentException("filename cannot be null");
  ...
  public FieldProvider lineFixedSize(String linea) {
    if (linea == null || linea.length() < 1)
      return null;
    MultipartRequest2 data = new MultipartRequest2();

    ...
    try{
      ...
      if (isPRapprovalworkflow.equals("Y")) {
        if (isPRapprover.equals("Y")){
          ...
          approveButtons=approveButtons + ConfigureButton.doConfigure(this, vars,script, "approve", 1, 1,false, "lock", "submitCommandForm('ADD', true, null, null, '_self', true);return false;", "", "");
          approveButtons=approveButtons + ConfigureButton.doConfigure(this, vars,script, "reject", 1, 1,false, "erase", "submitCommandForm('REJECT', true, null, null, '_self', true);return false;", "", "");
          approveButtons=approveButtons + ConfigureButton.doConfigure(this, vars,script, "remove", 1, 1,false, "cancel", "submitCommandForm('REMOVE', true, null, null, '_self', true);return false;", "", "");
        }
       }
       else {
         //show Buttons for selection and generation
         approveButtons=approveButtons + ConfigureButton.doConfigure(this, vars,script, "add", 1, 1,false, "lock", "submitCommandForm('ADD', true, null, null, '_self', true);return false;", "", "");
         approveButtons=approveButtons + ConfigureButton.doConfigure(this, vars,script, "remove", 1, 1,false, "cancel", "submitCommandForm('REMOVE', true, null, null, '_self', true);return false;", "", "");
       }

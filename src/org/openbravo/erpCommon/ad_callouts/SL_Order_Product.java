...
public class SL_Order_Product extends ProductTextHelper {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      try {
        printPage(response, vars, strChanged, 
            ...
            strPriceListVersionID,strMManufacturerID,str2ndUom,str2ndUomQty);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strChanged, 
      ...
      String strPriceListVersionID,String strMManufacturerID,String str2ndUom,String str2ndUomQty)
    ...
    if (!strMProductID.equals("")) {
      ...
      if (strChanged.equals("inpmProductId")) { // ("inpqtyordered")) {
        BigDecimal qtyPurchase = new BigDecimal(SLOrderAmtData.mrp_getpo_qty(this, strMProductID, dataOrder[0].cBpartnerId, actualqty,str2ndUom,strMManufacturerID));
        if (!actualqty.equals(qtyPurchase.toString())) {

          BigDecimal qtyPurchaseStd = new BigDecimal(SLOrderAmtData.mrp_getpo_qtystd(this, strMProductID, dataOrder[0].cBpartnerId,str2ndUom,strMManufacturerID));
          BigDecimal qtyPurchaseMin = new BigDecimal(SLOrderAmtData.mrp_getpo_qtymin(this, strMProductID, dataOrder[0].cBpartnerId,str2ndUom,strMManufacturerID));
          String qtyPurchaseIsMultiple = new String(SLOrderAmtData.mrp_getpo_ismultipleofminimumqty(this, strMProductID, dataOrder[0].cBpartnerId,str2ndUom,strMManufacturerID));
     ...
     strPriceActual = SLOrderProductData.getOffersPrice(this,dataOrder[0].dateordered,
            dataOrder[0].cBpartnerId, strMProductID,actualqty, dataOrder[0].mPricelistId,str2ndUom,strMManufacturerID, dataOrder[0].id);
      
      // SZ added Position Text
      strPositionText = this.getDocumentText(strMProductID, strCBpartnerID, strIsSOTrx, strADOrgID,strLang,str2ndUom,strMManufacturerID);
      dataOrder = null;
    } else {
...
//    }
    ...
    if (strIsSOTrx.equals("N")) {
      try {
        // Manufacturer
        resultado.append("new Array(\"inpmManufacturerId\", ");
        ...
        tld =SelectBoxhelper.getReferenceDataByRefName(this, vars, "m_manufacturer_id", "BE635A9B5F1245039EE7D81F5636283D", null,null , false);  

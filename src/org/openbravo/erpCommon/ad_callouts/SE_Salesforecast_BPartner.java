...
public class SE_Salesforecast_BPartner extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strBPartner,
    ...
    if (data != null && data.length > 0) {
      ...
      strUserRep = SESalesforecastBPartnerData.userIdSalesRep(this, data[0].salesrepId);
    ...
    strMwarehouse = SESalesforecastBPartnerData.mWarehouse(this, strBPartner);
    ...
    resultado.append("var calloutName='SE_Salesforecast_BPartner';\n\n");
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "LIST", "",
          "C_Order InvoiceRule", "", Utility.getContext(this, vars, "#AccessibleOrgTree",
              "SESalesforecastBPartner"),
          Utility.getContext(this, vars, "#User_Client", "SESalesforecastBPartner"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "SESalesforecastBPartner", "");
    ...
    resultado.append("new Array(\"inpcPaymenttermId\", \""
        + (strPaymentterm.equals("") ? SESalesforecastBPartnerData.selectPaymentTerm(this, Utility

...
public abstract class ProductTextHelper extends HttpSecureAppServlet {
  ...
  public String getDocumentText(String mProductId, String cBpartnerID,
      String isSOtrx,String adOrgId,String language,String str2ndUom,String strMManufacturerID) throws ServletException {
    return getDocumentText( mProductId, cBpartnerID,
        isSOtrx,adOrgId, language,str2ndUom,strMManufacturerID,this);
  }
  
  public String getDocumentText(String mProductId, String cBpartnerID,
         String isSOtrx,String adOrgId,String language,String str2ndUom,String strMManufacturerID,
        ...
        while (it.hasNext()) {
          ...
          if (field.equals("vendpnumberdnOrdernum")) 
            if (isSOtrx.equalsIgnoreCase("N")){
              if (str2ndUom==null && strMManufacturerID==null) {
                ...
                if (!ProductTextData.getVendorProductNoWithMFAndUOM(connp, mProductId, cBpartnerID,str2ndUom,strMManufacturerID).equals("")) {
                  doctext=doctext+ new Util().getText( "zssi_vendorproductno" , language , connp)
                             + ProductTextData.getVendorProductNoWithMFAndUOM(connp, mProductId, cBpartnerID,str2ndUom,strMManufacturerID) + "\n";
              }
              if (ProductTextData.isManufacturerdataSpecific(connp, mProductId, cBpartnerID,str2ndUom,strMManufacturerID).equals("1"))
                    doctext=doctext+ new Util().getText( "zssi_manufacturertext" , language , connp)
                    + ProductTextData.getManufacturerdataSpecific(connp, mProductId, cBpartnerID,str2ndUom,strMManufacturerID) + "\n";
              }

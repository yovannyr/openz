...
public class ConfigureNumberbox {
  ...
  public static StringBuilder doConfigure(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,int maxlength,boolean required,boolean readonly,String callout,  String format,String currentvalue,String tooltip,String elementId) throws Exception{
    ...
    if (strformat.equals(""))
      strformat=format;
    return doConfigureAll(servlet,vars,script,fieldname,leadingemptycols,colstotal, maxlength,required,readonly,callout,strformat,currentvalue, "",false,"",tooltip,elementId);
  }
  public static StringBuilder doConfigureGrid(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int colspan,int maxlength,boolean required,boolean readonly,String callout, String flavor,String currentvalue,String jssettings,String tooltip) throws Exception{
    String strformat="";
    ...
    return doConfigureAll(servlet,vars,script,fieldname,0,colspan+1, maxlength,required,readonly, callout,strformat,currentvalue, "",true,jssettings,tooltip,"");
  }
  ...
  private static StringBuilder doConfigureAll(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,int maxlength,boolean required,boolean readonly,String callout,  String format,String currentvalue,String labeltext, boolean isGrid, String jssettings, String title,String elementId) throws Exception{
    ...
    if (jssettings.equals(""))
      stdJSSettings="onkeydown=\"changeToEditingMode('onkeydown'); numberInputEvent('onkeydown', this, event);\" onkeypress=\"changeToEditingMode('onkeypress');\" oncut=\"changeToEditingMode('oncut');\" onpaste=\"changeToEditingMode('onpaste');\" oncontextmenu=\"changeToEditingMode('oncontextmenu');\" onchange=\"logChanges(this); numberInputEvent('onchange', this); @CALLOUT@; displayLogic();return true;\"  onfocus=\"numberInputEvent('onfocus', this);\" onblur=\"numberInputEvent('onblur', this);\"";
    ...
    Object template =  servlet.getServletContext().getAttribute("numberboxTEMPLATE");
    if (template==null) {

...
public class ConfigureDatebox {
  ...
  public static StringBuilder doConfigure(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,boolean required,boolean readonly,String currentvalue,String callout, String tooltip, String elementId) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, leadingemptycols,colstotal,required,readonly,currentvalue,callout, "", false, "",tooltip,elementId);
    
  }
  public static StringBuilder doConfigureGrid(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int colspan,boolean required,boolean readonly,String currentvalue,String callout, String jssettings, String tooltip) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, 0,colspan+1,required,readonly,currentvalue,callout, "", true, jssettings,tooltip,"");
  }
  private static StringBuilder doConfigureAll(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,boolean required,boolean readonly,String currentvalue,String callout, String labeltext, boolean isGrid, String jssettings,String title,String elementId) throws Exception{
    ...
    Object template =  servlet.getServletContext().getAttribute("dateboxTEMPLATE");
    if (template==null) {

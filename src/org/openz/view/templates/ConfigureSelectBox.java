...
public class ConfigureSelectBox{
  ...
  public static StringBuilder doConfigure(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,boolean required,boolean readonly,String callout,String currentvalue, FieldProvider[] data,  String dataIDField,String tooltip, Boolean firstitemempty,String elementId) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, leadingemptycols,colstotal,required,readonly,callout,currentvalue, data,  dataIDField,"",false, "",tooltip,firstitemempty,null,null,false,elementId);
  }
  public static StringBuilder doConfigureLink(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,boolean required,boolean readonly,String callout,String currentvalue, FieldProvider[] data,  String dataIDField,String tooltip, Boolean firstitemempty, String adReferenceId, String adTableId,String elementId) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, leadingemptycols,colstotal,required,readonly,callout,currentvalue, data,  dataIDField,"",false, "",tooltip,firstitemempty,adReferenceId,adTableId,true,elementId);
  }
  public static StringBuilder doConfigureNoLink(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,boolean required,boolean readonly,String callout,String currentvalue, FieldProvider[] data,  String dataIDField,String tooltip, Boolean firstitemempty, String adReferenceId, String adTableId,String elementId) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, leadingemptycols,colstotal,required,readonly,callout,currentvalue, data,  dataIDField,"",false, "",tooltip,firstitemempty,adReferenceId,adTableId,false,elementId);
  }
  public static StringBuilder doConfigureGrid(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int colspan,boolean required,boolean readonly,String callout,String currentvalue, FieldProvider[] data,  String jssettings, String tooltip, Boolean firstitemempty) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, 0,colspan+1,required,readonly,callout,currentvalue, data,  "ID","",true, "",tooltip,firstitemempty,null,null,false,"");
  }
  ...
  private static StringBuilder doConfigureAll(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,boolean required,boolean readonly,String callout,String currentvalue, FieldProvider[] data,  String dataIDField,String labeltext,boolean isGrid, String jssettings,String title, Boolean firstitemempty, String adReferenceId,String adTableId,Boolean link,String elementId) throws Exception{
    ...
    if (readonly)
      Replace.replace(retval, "@READONLY@", "disabled");
    else

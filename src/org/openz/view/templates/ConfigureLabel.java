...
public class ConfigureLabel {
  ...
  public static StringBuilder doConfigure(HttpSecureAppServlet servlet,VariablesSecureApp vars,String fieldname,String classname,  String labeltext, String elementId) throws Exception{
  ...
  public static StringBuilder doConfigure(HttpSecureAppServlet servlet,VariablesSecureApp vars,String fieldname,String classname,  String labeltext, String elementId,int colstotal) throws Exception{
    StringBuilder retval= new StringBuilder();
    String text=labeltext;
  ...
  public static StringBuilder doConfigureLink(HttpSecureAppServlet servlet,VariablesSecureApp vars,String fieldname,String classname,  String labeltext, String adReferenceId, String adTableID, String elementId) throws Exception{
    StringBuilder retval= new StringBuilder();
    String text=labeltext;

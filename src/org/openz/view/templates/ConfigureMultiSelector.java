...
public class ConfigureMultiSelector {
  ...
  public static StringBuilder doConfigure(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,boolean required,boolean readonly,String selector,String currentvalue,FieldProvider[] currentdata, String currentdataIDField,String tooltip,String elementId, String callout) throws Exception{
    ...
    strCurrenSelects=SelectBoxhelper.fields2option(currentdata,currentdataIDField.equals("") ?  fieldname: currentdataIDField,currentvalue,false,false);

...
public class ConfigurePAttribute {
  ...
  public static StringBuilder doConfigure(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,boolean required,boolean readonly,String currentidvalue,String callout, String tooltip, String elementId) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, leadingemptycols,colstotal,required,readonly,currentidvalue,callout, "", false, "",tooltip,elementId);
    
  }
  public static StringBuilder doConfigureGrid(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int colspan,boolean required,boolean readonly,String currentidvalue,String callout, String jssettings, String tooltip) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, 0,colspan+1,required,readonly,currentidvalue,callout, "", true, jssettings,tooltip,"");
  }
  private static StringBuilder doConfigureAll(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,boolean required,boolean readonly,String currentidvalue,String callout, String labeltext, boolean isGrid, String jssettings,String title,String elementId) throws Exception{
    ...
    Object template =  servlet.getServletContext().getAttribute("attributeFieldTEMPLATE");
    if (template==null) {

...
public class ConfigureCheckbox {
  ...
  public static StringBuilder doConfigure(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,String callout,String value,boolean checked, boolean readonly, String tooltip, String elementId) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, leadingemptycols,colstotal,callout,value,checked, readonly, "", false,"",tooltip, elementId);
  }
  public static StringBuilder doConfigureGrid(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname,int colstotal,String callout,String value,boolean checked, boolean readonly, String jssettings, String elementId) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, 0,colstotal,callout,value,checked, readonly, "", true,jssettings,"", elementId);
  }

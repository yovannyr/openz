...
public class CrudOperations {
   ...
   public static void UpdateCustomFields(String tabid,String IDKey,VariablesSecureApp vars,HttpSecureAppServlet servlet) throws ServletException
   {
     String value="";
     ...
     for (int i=0;i<data.length;i++) {
       ...
       if (data[i].ptype.equals("STRING")||data[i].ptype.equals("TIMESTAMP"))
         value="'" + vars.getStringParameter("inp" + Sqlc.TransformaNombreColumna(data[i].pname)) + "'";
     ...
     try {
       st = servlet.getPreparedStatement(strSQL);
     ...
     try {
       servlet.releaseTransactionalPreparedStatement(st);

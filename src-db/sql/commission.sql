...
****************************************************************************************************************************************************/
  ...
  BEGIN --BODY
    ...
    */
      FOR CUR_CLine IN
        (   SELECT b.ad_org_id as Org_ID,b.m_product_category_id , b.m_product_id , b.c_bp_group_id , b.c_bpartner_id , b.c_salesregion_id,b.C_CommissionLine_id,
            b.commissionorders from (
            ...
            group by c_commission_id,m_product_category_id , m_product_id , c_bp_group_id , c_bpartner_id , c_salesregion_id,commissionorders) a,C_CommissionLine b
            where a.c_commission_id=b.c_commission_id 
      ...
      LOOP
        ...
        ELSIF(v_DocBasisType='I') THEN
          ...
          -- Order Basis (O)
        ELSE
            v_Cmd:='SELECT h.C_Currency_ID, case when ad_get_docbasetype(h.c_doctype_id)= ''SOO'' then l.LineNetAmt else 0 end as LineNetAmt,'

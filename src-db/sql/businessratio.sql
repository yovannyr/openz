...
BEGIN 
   ...
   select sum((case when zssi_getOrderLineValueByPeriod(ol.c_orderline_id,v_datefrom,v_enddate)-zssi_getinvoicedamt4orderlineByPeriod(ol.c_orderline_id,v_datefrom,v_enddate)<0 then 0 
                   else zssi_getOrderLineValueByPeriod(ol.c_orderline_id,v_datefrom,v_enddate)-zssi_getinvoicedamt4orderlineByPeriod(ol.c_orderline_id,v_datefrom,v_enddate) end ) *
...
BEGIN 
   ...
   select sum(zssi_getOrderLineValueByPeriod(ol.c_orderline_id,v_datefrom,v_enddate))  into v_retval 
          from c_order o,c_orderline ol

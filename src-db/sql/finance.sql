        ...
        if v_cur.isparent='N' then
           ...
           if v_acctmatch in ('9150','9151','9152','9157','9158','9159') then
                 ...
                 from c_order where (c_order.docstatus = 'CO' or c_order.docstatus = 'DR')         
                       ...
                       and trunc(c_order.dateordered)+v_adddays between trunc(date_from) and trunc(date_to) 
                 ...
                 -- Sales Forecast
                  ...
                  from mrp_salesforecast where trunc(startdate) +v_adddays between trunc(date_from) and trunc(date_to) and ad_org_id=v_org;
                 ...
                 --   'Forderungen' und Verbindlichkleiten
                  ...
                  from c_debt_payment dp where   dp.isvalid='Y' and
                       ...
                       and trunc(dp.dateplanned) + v_adddays between trunc(date_from) and trunc(date_to)
...
BEGIN
  ...
  LOOP
      ...
      FOR v_i IN 1..v_count LOOP
        ...
        insert into fact_acct(FACT_ACCT_ID, AD_CLIENT_ID, AD_ORG_ID, ISACTIVE, CREATED, CREATEDBY, UPDATED, UPDATEDBY, C_ACCTSCHEMA_ID,
                              ...
                              ACCTVALUE, ACCTDESCRIPTION,m_product_id)
                    values(get_UUID(),v_Client,v_Org,'Y',now(),v_User,now(),v_User,v_acctshema,
                            ...
                            v_acct_val,v_acct_desc,v_cur_line.m_product_id);
  ...
  if (select count(*) from zsfi_macctline where zsfi_manualacct_id=v_Record and c_project_id is not null)>0 then
      ...
      select ad_client_id,c_acctschema_id into v_client_id,v_acctschema_id from ad_org_acctschema limit 1;
        ...
        --Customer
            ...
            --SKR3
                ...
                (v_acc_id, v_client_id, p_org_id,'Y',now(),100, now(),100, v_seqno , zssi_getbpname(p_bpartner_id),zssi_getbpname(p_bpartner_id),'A','N', 'C76385D3874B4775B28CEC5ECBCE1E5B','N','Y','A','C','N','N');
            ...
            --SKR4
                ...
                Insert into c_elementvalue (
                c_elementvalue_id,ad_client_id,ad_org_id,isactive,created,createdby,updated,updatedby,VALUE,NAME,DESCRIPTION,accounttype,accountsign,c_element_id,issummary,showelement,showvaluecond,elementlevel,nomanualacct,datevuseauto) values 
                (v_acc_id, v_client_id, p_org_id,'Y',now(),100, now(),100, v_seqno, zssi_getbpname(p_bpartner_id),zssi_getbpname(p_bpartner_id),'A','N', 'D871D9715A904125974B545FC0FF0681','N','Y','A','C','N','N');

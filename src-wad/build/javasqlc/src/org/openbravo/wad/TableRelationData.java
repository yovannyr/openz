...
class TableRelationData implements FieldProvider {
...
The table references in dictionary
 */
  public static TableRelationData[] selectValidation(ConnectionProvider connectionProvider)    throws ServletException {
...
The table references in dictionary
 */
  public static TableRelationData[] selectValidation(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 

...
Names of the columns and name of the fields of a tab
 */
  public static String tableId(ConnectionProvider connectionProvider, String adReferenceId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT AD_TABLE_ID " +
      "      FROM AD_REF_TABLE " +
...
Names of the columns and name of the fields of a tab
 */
  public static String columnName(ConnectionProvider connectionProvider, String adReferenceId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT C.COLUMNNAME " +
...
Names of the columns and name of the fields of a tab
 */
  public static String keyColumnName(ConnectionProvider connectionProvider, String tablename)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT C.COLUMNNAME " +

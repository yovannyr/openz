...
public class InternalTransportInbound  extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try {
      ...
      if ((strpdcFormerDialogue.equals(""))||(strpdcFormerDialogue.equals("/org.openz.internallogistic.ad_forms/InternalTransportInbound.html"))){
      ...
      if (BcCommand.equals("SAVE_NEW_NEW")) {
        if (!vars.getStringParameter("inp" + BarcodeADName).isEmpty()) {
         ...
         // Assume a serial Number was scanned....
            strProductid=SerialNumberData.getProductIdFromSerialConsumedINWorkstep(this,strIdentifier, GlobalWorkstepID);
     ...
     // Abort (Delete) this Transaction and go back to the Main Screen
      ...
      upperGridData = InternalLogisticData.selectupperInbound(this, vars.getLanguage(), GlobalWorkstepID,GlobalUserID,GlobalConsumptionID);   // Load upper grid date with language for translation
      ...
      lowerGridData =InternalLogisticData.selectlowerInbound(this, vars.getLanguage(),vars.getSessionValue("pdcWorkStepID"), vars.getSessionValue("pdcConsumptionID"));   // Load lower grid date with language for translation

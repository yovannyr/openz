...
public class BOMConsumption  extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
      ...
      if (vars.commandIn("CANCEL")){
       ...
       upperGridData = PdcMaterialConsumptionData.selectupper(this, vars.getLanguage(),strConsumptionid, strpdcWorkstepID);   // Load upper grid date with language for translation
       String strUpperGrid = "";
